      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              <div
                className={`relative px-4 py-2 rounded-2xl max-w-[75%] wrap-break-words text-sm shadow-sm transition-all duration-200 ${
                  isSender
              ...
              >
                ...
                <span
                  className={`absolute opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-[10px] top-3.5 ${
