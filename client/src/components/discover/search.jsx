            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
              {users.map((user) => (
                <motion.div
                  ...
                  className="bg-linear-to-br from-[#1a1c20] to-[#23272b] rounded-xl overflow-hidden border border-gray-800 cursor-pointer hover:border-blue-500 shadow-md hover:shadow-lg transition-all"
                >
