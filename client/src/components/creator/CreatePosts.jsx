...
const CreatePosts = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-extrabold text-center bg-linear-to-r from-blue-400 via-cyan-300 to-blue-500 bg-clip-text text-transparent">
        Create Post
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-6">
        ...
        <motion.button
          ...
          type="submit"
          disabled={loading}
          className="w-full py-3 rounded-xl font-bold text-white bg-linear-to-r from-blue-600 via-cyan-500 to-blue-600 hover:opacity-90 transition-all shadow-lg disabled:opacity-60"
        >
