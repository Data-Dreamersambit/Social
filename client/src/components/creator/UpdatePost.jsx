...
const UpdatePost = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-lg mx-auto sm:mt-12 bg-linear-to-b from-[#111827] via-[#1f2937] to-[#111827] 
        text-gray-100 rounded-2xl shadow-2xl border border-gray-800 p-2 pb-20 sm:p-8"
    >
      <h2 className="text-3xl font-extrabold text-center bg-linear-to-r from-yellow-400 via-orange-400 to-pink-500 bg-clip-text text-transparent">
        Update Post
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-6">
        ...
        <motion.button
          ...
          type="submit"
          disabled={loading}
          className="w-full py-3 rounded-xl font-bold text-white bg-linear-to-r from-yellow-500 via-orange-500 to-pink-500 hover:opacity-90 transition-all shadow-lg disabled:opacity-60"
        >
