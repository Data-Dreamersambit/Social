...
const PostCard = ({ post }) => {
  ...
  return (
    <div
      ref={postRef}
       className="w-full md:w-[400px] lg:w-[450px] bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] rounded-2xl shadow-sm mb-8 border border-gray-200 dark:border-neutral-700 overflow-hidden"
    >
      {/* 🧑‍💼 Header */}
